...
Maid is a free and open source application for interfacing with llama.cpp models locally, and with [API Route](https://www.api-route.com), Anthropic, DeepSeek, Mistral, Novita, Ollama, [llmman](https://github.com/llmmanorg/llmman), [OrcaRouter](https://www.orcarouter.ai) and OpenAI models remotely. Maid is built using React Native and is available for Android. The application is designed to be fast, efficient and user-friendly, making it easy for users to interact with their models on the go.
...
- **Remote providers** — connect to API Route, Anthropic, DeepSeek, Mistral, Novita, Ollama, llmman, OrcaRouter, and OpenAI with your own API key
