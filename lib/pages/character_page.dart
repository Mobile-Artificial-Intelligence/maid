              ...
              child: Column(
                children: [
                  ...
                  Material(
                    ...
                    child: CircleAvatar(
                      backgroundImage:
                          const AssetImage("assets/defaultResponseProfile.png"),
                  ...
                  DoubleButtonRow(
                    ...
                    leftOnPressed: () async {
                      await storageOperationDialog(
                          context, character.loadCharacterFromJson);
                      setState(() {});
                    },
                    rightText: "Save JSON",
                    rightOnPressed: () async {
                      await storageOperationDialog(
                          context, character.saveCharacterToJson);
                      setState(() {});
                    },
                  ),
                  const SizedBox(height: 20.0),
                        ...
                        Expanded(
                          ...
                          child: Material(
                            ...
                            child: TextField(
                              ...
                              onSubmitted: (value) {
                                if (MemoryManager.getCharacters()
                                    .contains(value)) {
